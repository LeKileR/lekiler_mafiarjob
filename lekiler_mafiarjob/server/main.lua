...
TriggerEvent('esx_society:registerSociety', 'mafiar', 'mafia russe', 'society_mafiar', 'society_mafiar', 'society_mafiar', {type = 'public'})
...
ESX.RegisterServerCallback('esx_afiajob:getOtherPlayerData', function(source, cb, target)
...
ESX.RegisterServerCallback('esx_afiajob:getFineList', function(source, cb, category)

  MySQL.Async.fetchAll(
    'SELECT * FROM fine_types_afia WHERE category = @category',
    {
      ['@category'] = category
    },
    function(fines)
...
ESX.RegisterServerCallback('esx_afiajob:getVehicleInfos', function(source, cb, plate)
...
ESX.RegisterServerCallback('esx_afiajob:getArmoryWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_afia', function(store)
...
ESX.RegisterServerCallback('esx_afiajob:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_afiajob:removeArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_afiajob:buy', function(source, cb, amount)
...
ESX.RegisterServerCallback('esx_afiajob:getStockItems', function(source, cb)
...
ESX.RegisterServerCallback('esx_afiajob:getPlayerInventory', function(source, cb)
